...
def izracunaj():
	...
	Desna5=np.cross(np.cross(Desna8,MaliNedogled1d),np.cross(Desna1,MaliNedogled2d))
	...
	Desna6=[Desna6[0]/Desna6[2],Desna6[1]/Desna6[2],Desna6[2]/Desna6[2]]
		...
		#srednja
	SrednjiNedogled1=np.cross(np.cross(Leva13,Leva16),np.cross(Leva9,Leva12))
	SrednjiNedogled2=np.cross(np.cross(Leva12,Leva11),np.cross(Leva16,Leva15))
	SrednjiNedogled3=np.cross(np.cross(Leva11,Leva15),np.cross(Leva12,Leva16))
	...
	Leva10=np.cross(np.cross(SrednjiNedogled2,Leva9),np.cross(SrednjiNedogled1,Leva11))
	Leva10=[Leva10[0]/Leva10[2],Leva10[1]/Leva10[2],Leva10[2]/Leva10[2]]
	Leva14=np.cross(np.cross(SrednjiNedogled2,Leva13),np.cross(SrednjiNedogled1,Leva15))
	...
	print("Ovde")
	for i in range(0,len(konacneTacke)):
		if(konacneTacke[i][0]<greska):
			konacneTacke[i][0]=konacneTacke[i][0]
		if(konacneTacke[i][1]<greska):
			konacneTacke[i][1]=konacneTacke[i][1]
		if(konacneTacke[i][2]<greska):
			konacneTacke[i][2]=konacneTacke[i][2]
		print("\n")
		print(konacneTacke[i])
	konacneTacke[1]=[konacneTacke[1][0]/(-10),konacneTacke[1][1]/(-10),konacneTacke[1][2]/(-10)]
	print(konacneTacke[1])
	return konacneTacke
...
def main():
	...
	glLoadIdentity()
	gluPerspective(60, 800/800, 1, 100000 )
